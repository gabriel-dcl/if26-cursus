...
import fr.utt.if26.duciel_cursus.models.entities.Etudiant;
...
public class BDOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "Cursus_2020.db";
    ...
    public void deleteModule(String moduleSigle) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(MODULE_TABLE_NAME, MODULE_ATTRIBUT_SIGLE + " = ?",
                new String[]{moduleSigle});
